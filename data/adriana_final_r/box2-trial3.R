...
#Volume of chamber in L, "micr" will refer to the control/blank chamber.
#volmicr<-0.260
#vol02<-0.262
#vol03<-0.264
#vol04<-0.268
...
#lot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(10,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B2C3")
