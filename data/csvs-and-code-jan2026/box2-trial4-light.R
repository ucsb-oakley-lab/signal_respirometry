...
#Data<-read.csv("box2-trial4-light.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box2-trial4-light.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(11,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B2C2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(10,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B2C3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(14,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B2C4")
