...
#Data<-read.csv("box2-trial4.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box2-trial4.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(0,23),xlab = "eTime (minutes)",ylab = O2_Units, main= "B2C4")
