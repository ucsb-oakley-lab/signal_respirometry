...
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box3-trial1.csv")

#Salinity
Sal<-33 #Based on Smithsonian surveys of the site

#Dry mass in grams. As example, using Daphnia pulez adult dry mass of 240 ug.The mass number is the channel number.
Mass02<-0.0076
Mass03<-0.007222222
Mass04<-0.007333333
...
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(0,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(0,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(0,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C4")
