...
#Data<-read.csv("box3-trial6-dark.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box3-trial6-dark.csv")
...
Temp<- median(trim_data[(DatQ==TRUE),5])
...
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(1,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C2")
#plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(5,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(1,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C4")
...
RMRD02$MO2<-RMRD02$MO2-0.00375913 #Taken from newpyro-trial6-dark
#RMRD03$MO2<-RMRD03$MO2-RMRDmicr$MO2
RMRD04$MO2<-RMRD04$MO2-0.00375913 #Taken from newpyro-trial6-dark
