...
#Data<-read.csv("box3-trial6-light.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box3-trial6-light.csv")
...
Temp<- median(trim_data[(DatQ==TRUE),6])
...
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(11,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(14,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(14,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "B3C4")
...
RMRD02$MO2<-RMRD02$MO2-0.003496675 #Taken from newpyro-trial6-light
RMRD03$MO2<-RMRD03$MO2-0.003496675 #Taken from newpyro-trial6-light
RMRD04$MO2<-RMRD04$MO2-0.003496675 #Taken from newpyro-trial6-light
