...
#Data<-read.csv("box3-trial7-dark.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box3-trial7-dark.csv")
...
RMRD02$MO2<-RMRD02$MO2-0.0005045038 #Taken from newpyro-trial7-dark
RMRD03$MO2<-RMRD03$MO2-0.0005045038 #Taken from newpyro-trial7-dark
RMRD04$MO2<-RMRD04$MO2-0.0005045038 #Taken from newpyro-trial7-dark
