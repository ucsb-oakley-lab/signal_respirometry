...
#Data<-read.csv("box3-trial7-light.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/box3-trial7-light.csv")
...
RMRD02$MO2<-RMRD02$MO2-0.006107106 #Taken from newpyro-trial7-light
RMRD03$MO2<-RMRD03$MO2-0.006107106 #Taken from newpyro-trial7-light
RMRD04$MO2<-RMRD04$MO2-0.006107106 #Taken from newpyro-trial7-light
