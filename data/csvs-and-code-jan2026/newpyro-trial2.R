...
#Data<-read.csv("newpyro-trial2.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial2.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(5,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(5,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(5,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC4")
