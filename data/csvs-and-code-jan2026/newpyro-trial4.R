...
#Data<-read.csv("newpyro-trial4.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial4.csv")
...
#plot(x=eTime[DatQ==TRUE],y=RMR_micr[DatQ==TRUE],ylim=c(13,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "Control")
#plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(13,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NP2")
#plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(13,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NP3")
#plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(13,20),xlab = "eTime (minutes)",ylab = O2_Units, main= "NP4")
...
#NP2
NP2<-conv_resp_unit(value=RMRD02$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
NP3<-conv_resp_unit(value=RMRD03$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
NP4<-conv_resp_unit(value=RMRD04$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)

#ul/mg/hr of all 20 individuals together
NP2*1000
#NP3*1000
NP4*1000
