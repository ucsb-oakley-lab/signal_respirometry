...
#Data<-read.csv("newpyro-trial6-dark.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial6-dark.csv")
