...
#Data<-read.csv("newpyro-trial6-light.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial6-light.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_micr[DatQ==TRUE],ylim=c(19,25),xlab = "eTime (minutes)",ylab = O2_Units, main= "Control")
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(10,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(10,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(10,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC4")
...
#B2C2
NC2<-conv_resp_unit(value=RMRD02$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
NC3<-conv_resp_unit(value=RMRD03$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
NC4<-conv_resp_unit(value=RMRD04$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
