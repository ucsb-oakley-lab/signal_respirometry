...
#Data<-read.csv("newpyro-trial7-dark.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial7-dark.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(1,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(1,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC4")
