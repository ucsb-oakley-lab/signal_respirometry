...
#Data<-read.csv("newpyro-trial7-light.csv")
Data<-read.csv("/Users/oakley/Documents/GitHub/signal_respirometry/data/csvs-and-code-jan2026/newpyro-trial7-light.csv")
...
plot(x=eTime[DatQ==TRUE],y=RMR_micr[DatQ==TRUE],ylim=c(10,21),xlab = "eTime (minutes)",ylab = O2_Units, main= "Control")
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(0,21.5),xlab = "eTime (minutes)",ylab = O2_Units, main= "NC2")
