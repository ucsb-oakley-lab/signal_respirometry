...
Data<-read.csv("light-prelim-box3-night-9Nov.csv")
...
trim_data<-subset(Data, hours>=1& hours<=6) #After 1h
...
plot(x=eTime[DatQ==TRUE],y=RMR_01[DatQ==TRUE],ylim=c(0,21),xlab = "eTime (minutes)",ylab = O2_Units, main= "Ch1")
plot(x=eTime[DatQ==TRUE],y=RMR_02[DatQ==TRUE],ylim=c(0,21),xlab = "eTime (minutes)",ylab = O2_Units, main= "Ch2")
plot(x=eTime[DatQ==TRUE],y=RMR_03[DatQ==TRUE],ylim=c(0,21),xlab = "eTime (minutes)",ylab = O2_Units, main= "Ch3")
plot(x=eTime[DatQ==TRUE],y=RMR_04[DatQ==TRUE],ylim=c(0,21),xlab = "eTime (minutes)",ylab = O2_Units, main= "Ch4")
...
#Box 2
Ch1_night<-conv_resp_unit(value=RMRD01$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
Ch2_night<-conv_resp_unit(value=RMRD02$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
Ch3_night<-conv_resp_unit(value=RMRD03$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
Ch4_night<-conv_resp_unit(value=RMRD04$MO2_mass_specific, from="umol_O2 / g / hr", to= "ml_O2 / mg / hr", temp = Temp, sal = Sal, atm_pres = 1013.25)
